...
failcount = 0
finalOutput = ""
passGrade = "PASSING GRADE!"
failGrade = "FAILED THE ASSIGNMENT :("
...
for f in files_list:
	...
	passPercentage = (passcount / counter) * 100
	finalOutput += "Pass percentage: {}%\n".format(str(passPercentage))
	if passPercentage >= 70:
		finalOutput += "Pass or Fail: {}\n".format(str(passGrade))
	else:
		finalOutput += "Pass or Fail: {}\n".format(str(failGrade))
